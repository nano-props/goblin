...
export const zh: Record<DictKey, string> = {
  ...
  'repo-picker.open-description': '输入本地路径，或选择一个文件夹。',
  'repo-picker.open-path-label': '文件夹路径',
  'repo-picker.open-path-placeholder': '~/Developer/repo',
  'repo-picker.open-path-choose': '选择…',
  'repo-picker.open-local-confirm': '打开工作区',
  ...
  'repo-picker.open-remote-title': '打开远程工作区',
  'repo-picker.open-remote-description': '选择一个 SSH 别名并填写工作区路径。',
  ...
  'repo-picker.open-remote-confirm': '打开远程工作区',
  ...
  'repo-picker.open-remote-config-only-hint': 'Goblin 仅支持通过 ~/.ssh/config 中定义的别名打开 SSH 远程工作区。',
  'repo-picker.open-remote-include-manual-hint':
    '检测到 Include 指令，别名列表可能不完整。请输入 SSH 别名，下面的建议仅来自当前文件。',
  'repo-picker.open-remote-config-required': '请先在 ~/.ssh/config 中添加一个具体的 Host 条目，再打开远程工作区。',
