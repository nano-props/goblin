...
export const zh: Record<DictKey, string> = {
  ...
  'workspace-pane-tabs.retry-loading': '重试加载标签页',
  ...
  'terminal.retry-loading': '重试加载终端',
  'terminal.load-failed': '无法加载终端',
  'terminal.workspace-state-inconsistent': '工作区标签页与终端状态不一致。请刷新页面后再继续。',
  'terminal.loading-tab': '正在加载终端…',
  'terminal.load-tab-failed': '无法加载终端',
  'terminal.restarting': '正在重启终端…',
  'terminal.restoring': '正在恢复终端…',
  'terminal.restore-failed': '无法恢复终端',
  'terminal.retry-restoring': '重试恢复终端',
  ...
  'terminal.new': '新终端',
  'terminal.new-disabled-loading': '请等待终端加载完成',
  'terminal.new-disabled-load-failed': '请先重试加载终端，再新建终端',
  'terminal.new-disabled-tabs-load-failed': '请先重试加载标签页，再新建终端',
  'terminal.new-disabled-state-inconsistent': '工作区标签页与终端状态不一致。请刷新页面后再新建终端。',
  'terminal.close': '关闭终端',
  ...
  'error.terminal-create-blocked-loading': '请等待工作区标签和终端加载完成后再试。',
  'error.terminal-create-blocked-load-failed': '请先重试加载失败的标签或终端，然后再试。',
  'error.workspace-pane-state-inconsistent': '工作区标签页与终端状态不一致。请刷新页面后再继续。',
  'error.workspace-tabs-close-blocked-loading': '请等待终端加载完成后再关闭。',
  'error.workspace-tabs-close-blocked-load-failed': '请先重试加载终端，再将其关闭。',
