...
export const zh: Record<DictKey, string> = {
  ...
  'repo-picker.open-description': '输入本地路径，或选择一个文件夹来打开 Git 仓库。',
  'repo-picker.open-path-label': '仓库路径',
  'repo-picker.open-path-placeholder': '~/Developer/repo',
  'repo-picker.open-path-choose': '选择…',
  'repo-picker.open-local-confirm': '打开本地仓库',
  'repo-picker.open-opening': '正在打开…',
  'repo-picker.clone': '克隆新仓库…',
  'repo-picker.clone-title': '克隆仓库',
  'repo-picker.clone-description': '克隆远端 Git 仓库并打开。',
  'repo-picker.clone-url-label': '仓库 URL',
  'repo-picker.clone-url-placeholder': 'https://github.com/owner/repo.git',
  'repo-picker.clone-parent-label': '保存到',
  'repo-picker.clone-parent-choose': '选择…',
  'repo-picker.clone-directory-label': '文件夹名',
  'repo-picker.clone-directory-placeholder': 'repo',
  'repo-picker.clone-directory-invalid': '请输入单个文件夹名，不能包含 /、\\ 或 :。',
  'repo-picker.clone-path-preview': '将克隆到 {path}',
  'repo-picker.clone-confirm': '克隆并打开',
  'repo-picker.clone-cloning': '正在克隆…',
  'repo-picker.clone-opened': '仓库已克隆',
  'repo-picker.open-remote-title': '打开远程仓库',
  'repo-picker.open-remote-description': '选择一个 SSH 别名并填写仓库路径。',
  'repo-picker.open-remote-host-label': '主机',
  'repo-picker.open-remote-host-alias-label': 'SSH 别名',
  'repo-picker.open-remote-host-placeholder': 'example.com',
  'repo-picker.open-remote-port-label': '端口',
  'repo-picker.open-remote-username-label': '用户名',
  'repo-picker.open-remote-private-key-label': '私钥',
  'repo-picker.open-remote-private-key-choose': '选择私钥',
  'repo-picker.open-remote-path-label': '远程路径',
  'repo-picker.open-remote-path-placeholder': '/home/user/repo 或 ~/repo',
  'repo-picker.open-remote-test-connection': '测试连接',
  'repo-picker.open-remote-confirm': '打开远程仓库',
  'repo-picker.open-remote-diagnostics-title': '连接测试',
  'repo-picker.open-remote-diagnostics-retry': '重试',
  'repo-picker.open-remote-diagnostics-testing': '正在测试连接…',
  'repo-picker.open-remote-diagnostics-ok': '连接正常',
  'repo-picker.open-remote-diagnostics-stage-ssh': 'SSH 可达',
  'repo-picker.open-remote-diagnostics-stage-shell': 'Shell 可用',
  'repo-picker.open-remote-diagnostics-stage-git': '已安装 Git',
  'repo-picker.open-remote-diagnostics-stage-path': '路径存在',
  'repo-picker.open-remote-diagnostics-stage-repo': 'Git 仓库有效',
  'repo-picker.open-remote-diagnostics-category-auth-failed': '认证失败',
  'repo-picker.open-remote-diagnostics-category-host-key': '主机密钥校验失败',
  'repo-picker.open-remote-diagnostics-category-unreachable': '主机不可达',
  'repo-picker.open-remote-diagnostics-category-handshake-failed': 'SSH 握手失败',
  'repo-picker.open-remote-diagnostics-category-shell-failed': 'Shell 不可用',
  'repo-picker.open-remote-diagnostics-category-git-missing': '未找到 Git',
  'repo-picker.open-remote-diagnostics-category-path-missing': '路径不存在',
  'repo-picker.open-remote-diagnostics-category-not-a-repo': '不是 Git 仓库',
  'repo-picker.open-remote-diagnostics-category-timeout': '连接超时',
  'repo-picker.open-remote-diagnostics-category-cancelled': '已取消',
  'repo-picker.open-remote-diagnostics-category-config-changed': 'SSH 配置已变更',
  'repo-picker.open-remote-diagnostics-category-unknown': '未知错误',
  'repo-picker.open-remote-diagnostics-copy-ssh-command': '复制 SSH 命令',
  'repo-picker.open-remote-diagnostics-copy-details': '复制详情',
  'repo-picker.open-remote-connect-via-ssh': '通过系统 SSH 连接',
  'repo-picker.open-remote-config-only-hint': 'Goblin 仅支持通过 ~/.ssh/config 中定义的别名打开 SSH 远程仓库。',
  'repo-picker.open-remote-include-manual-hint':
    '检测到 Include 指令，别名列表可能不完整。请输入 SSH 别名，下面的建议仅来自当前文件。',
  'repo-picker.open-remote-config-required': '请先在 ~/.ssh/config 中添加一个具体的 Host 条目，再打开远程仓库。',
  'repo-picker.open-remote-config-drift-hint':
    'Goblin 在每次打开和重连时都会重新读取 ~/.ssh/config。如果别名被删除或已无法解析，会直接标记为配置漂移。',
  'repo-picker.open-remote-open-ssh-settings': '打开 SSH 设置',
  'repo-picker.open-remote-ssh-config': 'SSH 配置',
  'repo-picker.open-remote-manual': '手动输入',
  'repo-picker.open-remote-no-ssh-hosts': '在 ~/.ssh/config 中没有找到 SSH 主机',
  'repo-picker.open-remote-no-ssh-hosts-help': '请添加类似 `Host my-server` 的具体 Host 配置后重新打开此弹窗。',
  'repo-picker.open-remote-path-preview': '将打开 {path}',
  'repo-picker.open-remote-path-preview-expanded': '将打开 {input}\n展开后为 {expanded}',
  'repo-picker.open-remote-diagnostics-idle-detail': '运行一次连接测试来验证这个目标。',
  'repo-picker.open-remote-private-key-hint': '使用系统 SSH。请确认密钥已加入 ssh-agent，或手动指定私钥路径。',
  ...
  'action.create-worktree-bootstrap-title': 'goblin.toml 初始化',
  'action.create-worktree-bootstrap-body':
    '这个仓库为新工作树配置了 goblin.toml 规则，可能会复制或链接文件，并在新工作树中运行 setup 命令。',
  'action.create-worktree-bootstrap-loading': '正在检查此仓库的 goblin.toml 初始化规则。',
  'action.create-worktree-bootstrap-note': '不勾选时将创建工作树，但不会执行这些操作。',
  'action.create-worktree-bootstrap-trusted': '当前 goblin.toml 配置已受信任，创建后会自动执行。',
  'action.create-worktree-bootstrap-copy-label': '复制条目',
  'action.create-worktree-bootstrap-symlink-label': '符号链接条目',
  'action.create-worktree-bootstrap-hardlink-label': '硬链接条目',
  'action.create-worktree-bootstrap-exclude-label': '排除规则',
  'action.create-worktree-bootstrap-setup-label': 'Setup 命令',
  'action.create-worktree-bootstrap-remember': '信任并执行此仓库的当前 goblin.toml 配置',
  'action.create-worktree-bootstrap-skip': '跳过并创建',
  'action.create-worktree-bootstrap-run': '执行初始化',
  'action.menu': '操作',
  'action.refresh': '同步',
  ...
  'error.workspace-tab-close-failed': '无法关闭工作区资源，请重试。',
  ...
  'error.worktree-bootstrap-not-confirmed': '尚未确认执行工作树初始化。',
