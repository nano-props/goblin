...
export const zh: Record<DictKey, string> = {
  ...
  'terminal.paste-text-failed': '无法将剪贴板文本粘贴到终端。',
  'terminal.mobile-toolbar': '终端输入辅助键',
  'terminal.mobile-key-tab': 'Tab',
  'terminal.mobile-key-arrow-up': '向上方向键',
  'terminal.mobile-key-arrow-down': '向下方向键',
  'terminal.mobile-key-arrow-left': '向左方向键',
  'terminal.mobile-key-arrow-right': '向右方向键',
