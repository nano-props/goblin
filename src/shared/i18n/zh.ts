...
export const zh: Record<DictKey, string> = {
  ...
  'menu.file.close-terminal-tab-or-window': '关闭终端标签页或窗口',
  ...
  'repo-picker.tooltip.no-remotes': '没有远端',
  'repo-picker.tooltip.last-sync-label': '上次同步',
  'repo-picker.tooltip.not-synced': '尚未同步',
  ...
  'help.row.close-terminal-tab-or-window': '关闭终端标签页或窗口',
