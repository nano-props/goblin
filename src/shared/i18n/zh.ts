...
export const zh: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-note': '不勾选信任时，只会为本次工作树执行；受信任配置下次会自动执行。',
  ...
  'action.create-worktree-bootstrap-skip': '跳过',
  'action.create-worktree-bootstrap-run': '执行初始化',
  'action.create-worktree-bootstrap-remember': '信任此仓库的当前 goblin.toml 配置',
  'action.menu': '操作',
  'action.refresh': '同步',
