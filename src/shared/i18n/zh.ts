...
export const zh: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-note': '选择“执行一次”只在本次运行；选择“信任并执行”会记住此仓库的当前配置。',
  ...
  'action.create-worktree-bootstrap-run': '执行一次',
  'action.create-worktree-bootstrap-trust-run': '信任并执行',
  'action.menu': '操作',
  'action.refresh': '同步',
