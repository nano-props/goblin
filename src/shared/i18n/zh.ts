...
export const zh: Record<DictKey, string> = {
  ...
  'workspace.branch-list-toggle-label': '切换 Branch View',
  'workspace.branch-list-toggle-tooltip.hide': '隐藏 Branch View',
  'workspace.branch-list-toggle-tooltip.show': '显示 Branch View',
