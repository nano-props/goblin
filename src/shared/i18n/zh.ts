...
export const zh: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-title': '运行 goblin.toml 初始化？',
  'action.create-worktree-bootstrap-body':
    '这个仓库为新工作树配置了 goblin.toml 规则，可能会复制或链接文件，并在新工作树中运行 setup 命令。',
  'action.create-worktree-bootstrap-note': '仅在信任此仓库配置时执行这些操作。',
  ...
  'action.create-worktree-bootstrap-remember': '以后对此仓库的当前 goblin.toml 配置自动执行',
