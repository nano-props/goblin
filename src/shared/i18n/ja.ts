...
export const ja: Record<DictKey, string> = {
  ...
  'repo-picker.clone-description': 'リモート Git リポジトリをクローンして開きます。',
  'repo-picker.clone-url-label': 'リポジトリ URL',
  'repo-picker.clone-url-placeholder': 'https://github.com/owner/repo.git',
  'repo-picker.clone-parent-label': '保存先',
  'repo-picker.clone-parent-choose': '選択…',
  'repo-picker.clone-directory-label': 'フォルダ名',
  'repo-picker.clone-directory-placeholder': 'repo',
  'repo-picker.clone-directory-invalid': 'フォルダ名は 1 つだけ指定し、/、\\、: は使えません。',
  'repo-picker.clone-path-preview': '{path} にクローンします',
  ...
  'repo-picker.open-remote-port-label': 'ポート',
  'repo-picker.open-remote-username-label': 'ユーザー名',
  'repo-picker.open-remote-private-key-label': '秘密鍵',
  'repo-picker.open-remote-private-key-choose': '秘密鍵を選択',
  ...
  'repo-picker.open-remote-diagnostics-ok': '接続は正常です',
  'repo-picker.open-remote-diagnostics-stage-ssh': 'SSH に接続可能',
  'repo-picker.open-remote-diagnostics-stage-shell': 'シェル利用可能',
  'repo-picker.open-remote-diagnostics-stage-git': 'Git インストール済み',
  'repo-picker.open-remote-diagnostics-stage-path': 'パスが存在する',
  'repo-picker.open-remote-diagnostics-stage-repo': '有効な Git リポジトリ',
  'repo-picker.open-remote-diagnostics-category-auth-failed': '認証に失敗しました',
  'repo-picker.open-remote-diagnostics-category-host-key': 'ホストキーの検証に失敗しました',
  'repo-picker.open-remote-diagnostics-category-unreachable': 'ホストに到達できません',
  'repo-picker.open-remote-diagnostics-category-handshake-failed': 'SSH ハンドシェイクに失敗しました',
  'repo-picker.open-remote-diagnostics-category-shell-failed': 'シェルを利用できません',
  'repo-picker.open-remote-diagnostics-category-git-missing': 'Git が見つかりません',
  'repo-picker.open-remote-diagnostics-category-path-missing': 'パスが見つかりません',
  'repo-picker.open-remote-diagnostics-category-not-a-repo': 'Git リポジトリではありません',
  'repo-picker.open-remote-diagnostics-category-timeout': 'タイムアウトしました',
  'repo-picker.open-remote-diagnostics-category-cancelled': 'キャンセルされました',
  'repo-picker.open-remote-diagnostics-category-config-changed': 'SSH 設定が変更されました',
  'repo-picker.open-remote-diagnostics-category-unknown': '不明なエラー',
  'repo-picker.open-remote-diagnostics-copy-ssh-command': 'SSH コマンドをコピー',
  'repo-picker.open-remote-diagnostics-copy-details': '詳細をコピー',
  'repo-picker.open-remote-connect-via-ssh': 'システム SSH で接続',
  ...
  'repo-picker.open-remote-ssh-config': 'SSH 設定',
  'repo-picker.open-remote-manual': '手動入力',
  'repo-picker.open-remote-no-ssh-hosts': '~/.ssh/config に SSH ホストが見つかりません',
  'repo-picker.open-remote-no-ssh-hosts-help':
    '`Host my-server` のような具体的な Host ブロックを追加してから、このダイアログを開き直してください。',
  'repo-picker.open-remote-path-preview': '{path} を開きます',
  'repo-picker.open-remote-path-preview-expanded': '{input} を開きます\n展開後のパス: {expanded}',
  'repo-picker.open-remote-diagnostics-idle-detail': '接続テストを実行してこのターゲットを確認してください。',
  ...
  'action.create-worktree-bootstrap-body':
    'このリポジトリには新しいワークツリー向けの goblin.toml ルールがあります。ファイルのコピーやリンク作成、ワークツリー内での setup コマンド実行が含まれる場合があります。',
  'action.create-worktree-bootstrap-loading': 'このリポジトリの goblin.toml bootstrap ルールを確認しています。',
  'action.create-worktree-bootstrap-note': 'チェックしない場合、ワークツリーは作成されますが、これらの操作は実行されません。',
  'action.create-worktree-bootstrap-trusted': 'この goblin.toml 設定は信頼済みで、作成後に実行されます。',
  'action.create-worktree-bootstrap-copy-label': 'コピー項目',
  'action.create-worktree-bootstrap-symlink-label': 'シンボリックリンク項目',
  'action.create-worktree-bootstrap-hardlink-label': 'ハードリンク項目',
  'action.create-worktree-bootstrap-exclude-label': '除外パターン',
  'action.create-worktree-bootstrap-setup-label': 'Setup コマンド',
  'action.create-worktree-bootstrap-remember': 'このリポジトリの現在の goblin.toml 設定を信頼して実行',
  'action.create-worktree-bootstrap-skip': 'スキップして作成',
  'action.create-worktree-bootstrap-run': 'Bootstrap を実行',
  'action.menu': '操作',
  'action.refresh': '同期',
  ...
  'error.workspace-tab-close-failed': 'ワークスペースリソースを閉じられませんでした。もう一度お試しください。',
  ...
  'error.worktree-bootstrap-not-confirmed': 'ワークツリーの bootstrap は確認されていません。',
