...
export const ja: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-title': 'goblin.toml の bootstrap を実行しますか?',
  ...
  'action.create-worktree-bootstrap-note': 'このリポジトリ設定を信頼できる場合にのみ実行してください。',
  ...
  'action.create-worktree-bootstrap-remember': 'このリポジトリでは現在の goblin.toml 設定を常に実行',
