...
export const ja: Record<DictKey, string> = {
  ...
  'workspace.branch-list-toggle-label': 'Branch View を切り替え',
  'workspace.branch-list-toggle-tooltip.hide': 'Branch View を非表示',
  'workspace.branch-list-toggle-tooltip.show': 'Branch View を表示',
