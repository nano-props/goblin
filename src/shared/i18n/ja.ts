...
export const ja: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-note':
    '信頼しない場合、bootstrap は今回のワークツリーでのみ実行されます。信頼済みの設定は次回から自動実行されます。',
  ...
  'action.create-worktree-bootstrap-skip': 'スキップ',
  'action.create-worktree-bootstrap-run': 'Bootstrap を実行',
  'action.create-worktree-bootstrap-remember': 'このリポジトリの現在の goblin.toml 設定を信頼',
  'action.menu': '操作',
  'action.refresh': '同期',
