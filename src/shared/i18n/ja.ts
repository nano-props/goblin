...
export const ja: Record<DictKey, string> = {
  ...
  'terminal.loading-font': 'ターミナルフォントを読み込んでいます…',
  'terminal.syncing-session': 'ターミナルセッションを同期しています…',
  'terminal.loading-content': 'ターミナルの内容を読み込んでいます…',
  'terminal.rendering': 'ターミナルを描画しています…',
  ...
  'terminal.composer-send-only': '送信のみ',
