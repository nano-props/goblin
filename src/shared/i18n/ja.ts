...
export const ja: Record<DictKey, string> = {
  ...
  'terminal.composer-close': 'ターミナル入力を閉じる',
  'terminal.composer-input-placeholder': 'ターミナルコマンドを入力',
  'terminal.composer-send': 'ターミナルに送信',
  'terminal.composer-select-files': 'ファイルを選択',
  ...
  'terminal.composer-key-page-up': '上へページ移動（ターミナルをスクロール）',
  'terminal.composer-key-page-down': '下へページ移動（ターミナルをスクロール）',
