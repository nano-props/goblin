...
export const ko: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-note':
    '신뢰하지 않으면 bootstrap은 이번 워크트리에만 실행됩니다. 신뢰한 구성은 다음부터 자동 실행됩니다.',
  ...
  'action.create-worktree-bootstrap-skip': '건너뛰기',
  'action.create-worktree-bootstrap-run': 'Bootstrap 실행',
  'action.create-worktree-bootstrap-remember': '이 저장소의 현재 goblin.toml 구성을 신뢰',
  'action.menu': '작업',
  'action.refresh': '동기화',
