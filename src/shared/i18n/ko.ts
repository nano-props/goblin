...
export const ko: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-title': 'goblin.toml bootstrap',
  'action.create-worktree-bootstrap-body':
    '이 저장소에는 새 워크트리용 goblin.toml 규칙이 있습니다. 파일을 복사하거나 링크하고, 새 워크트리에서 setup 명령을 실행할 수 있습니다.',
  'action.create-worktree-bootstrap-loading': '이 저장소의 goblin.toml bootstrap 규칙을 확인하는 중입니다.',
  'action.create-worktree-bootstrap-note': '선택하지 않으면 워크트리는 만들지만 이 작업들은 실행하지 않습니다.',
  'action.create-worktree-bootstrap-trusted': '이 goblin.toml 구성은 신뢰됨 상태이며 생성 후 실행됩니다.',
  'action.create-worktree-bootstrap-copy-label': '복사 항목',
  'action.create-worktree-bootstrap-symlink-label': '심볼릭 링크 항목',
  'action.create-worktree-bootstrap-hardlink-label': '하드 링크 항목',
  'action.create-worktree-bootstrap-exclude-label': '제외 패턴',
  'action.create-worktree-bootstrap-setup-label': 'Setup 명령',
  'action.create-worktree-bootstrap-remember': '이 저장소의 현재 goblin.toml 구성을 신뢰하고 실행',
  'action.create-worktree-bootstrap-skip': '건너뛰고 만들기',
  'action.create-worktree-bootstrap-run': 'Bootstrap 실행',
  'action.menu': '작업',
  'action.refresh': '동기화',
  ...
  'error.workspace-tab-close-failed': '작업 영역 리소스를 닫을 수 없습니다. 다시 시도하세요.',
  ...
  'error.worktree-bootstrap-not-confirmed': '작업 트리 bootstrap 실행이 확인되지 않았습니다.',
