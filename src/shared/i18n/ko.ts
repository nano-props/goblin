...
export const ko: Record<DictKey, string> = {
  ...
  'workspace.branch-list-toggle-label': 'Branch View 전환',
  'workspace.branch-list-toggle-tooltip.hide': 'Branch View 숨기기',
  'workspace.branch-list-toggle-tooltip.show': 'Branch View 보이기',
  ...
  'action.checkout-in-worktree': '이미 워크트리에 체크아웃됨',
