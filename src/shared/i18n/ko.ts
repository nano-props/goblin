...
export const ko: Record<DictKey, string> = {
  ...
  'action.create-worktree-bootstrap-title': 'goblin.toml bootstrap을 실행할까요?',
  'action.create-worktree-bootstrap-body':
    '이 저장소에는 새 워크트리용 goblin.toml 규칙이 있습니다. 파일을 복사하거나 링크하고, 새 워크트리에서 setup 명령을 실행할 수 있습니다.',
  'action.create-worktree-bootstrap-note': '이 저장소 구성을 신뢰할 수 있을 때만 실행하세요.',
  ...
  'action.create-worktree-bootstrap-remember': '이 저장소의 현재 goblin.toml 구성은 항상 실행',
