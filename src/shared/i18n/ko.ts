...
export const ko: Record<DictKey, string> = {
  ...
  'terminal.paste-text-failed': '클립보드 텍스트를 터미널에 붙여넣지 못했습니다.',
  'terminal.mobile-toolbar': '터미널 입력 도우미',
  'terminal.mobile-key-tab': 'Tab',
  'terminal.mobile-key-arrow-up': '위쪽 화살표 키',
  'terminal.mobile-key-arrow-down': '아래쪽 화살표 키',
  'terminal.mobile-key-arrow-left': '왼쪽 화살표 키',
  'terminal.mobile-key-arrow-right': '오른쪽 화살표 키',
