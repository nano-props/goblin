...
export const en = {
  ...
  'action.create-worktree-bootstrap-note':
    'Choose Run once to execute this time only, or Trust and run to remember this config for this repository.',
  ...
  'action.create-worktree-bootstrap-run': 'Run once',
  'action.create-worktree-bootstrap-trust-run': 'Trust and run',
  'action.menu': 'Actions',
  'action.refresh': 'Sync',
