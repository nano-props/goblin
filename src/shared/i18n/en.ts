...
export const en = {
  ...
  'workspace-pane-tabs.retry-loading': 'Retry loading tabs',
  ...
  'terminal.loading-font': 'Loading terminal font…',
  'terminal.syncing-session': 'Syncing terminal session…',
  'terminal.loading-content': 'Loading terminal content…',
  'terminal.rendering': 'Rendering terminal…',
  'terminal.restore-failed': 'Unable to restore terminal',
  'terminal.retry-restoring': 'Retry restoring terminal',
