...
export const en = {
  ...
  'action.create-worktree-bootstrap-title': 'Run goblin.toml bootstrap?',
  ...
  'action.create-worktree-bootstrap-note': 'Run them only if you trust this repository configuration.',
  ...
  'action.create-worktree-bootstrap-remember': 'Always run this goblin.toml config for this repository',
