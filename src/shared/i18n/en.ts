...
export const en = {
  ...
  'action.create-worktree-bootstrap-note':
    'Without trust, bootstrap runs only for this worktree. Trusted configs run automatically next time.',
  ...
  'action.create-worktree-bootstrap-skip': 'Skip',
  'action.create-worktree-bootstrap-run': 'Run bootstrap',
  'action.create-worktree-bootstrap-remember': 'Trust this goblin.toml config for this repository',
  'action.menu': 'Actions',
  'action.refresh': 'Sync',
