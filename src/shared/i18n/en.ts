...
export const en = {
  ...
  'terminal.paste-text-failed': 'Could not paste clipboard text into the terminal.',
  'terminal.mobile-toolbar': 'Terminal input helpers',
  'terminal.mobile-key-tab': 'Tab',
  'terminal.mobile-key-arrow-up': 'Arrow up',
  'terminal.mobile-key-arrow-down': 'Arrow down',
  'terminal.mobile-key-arrow-left': 'Arrow left',
  'terminal.mobile-key-arrow-right': 'Arrow right',
  'terminal.mobile-key-escape': 'Escape',
