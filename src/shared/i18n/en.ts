...
export const en = {
  ...
  'action.create-worktree-bootstrap-body':
    'This repository has goblin.toml rules for new worktrees. They can copy or link files and may run a setup command in the new worktree.',
  'action.create-worktree-bootstrap-loading': 'Checking this repository for goblin.toml bootstrap rules.',
  'action.create-worktree-bootstrap-note': 'Leave unchecked to create the worktree without running these operations.',
  'action.create-worktree-bootstrap-trusted': 'This goblin.toml config is trusted and will run after creation.',
  'action.create-worktree-bootstrap-copy-label': 'Copy entries',
  'action.create-worktree-bootstrap-symlink-label': 'Symlink entries',
  'action.create-worktree-bootstrap-hardlink-label': 'Hardlink entries',
  'action.create-worktree-bootstrap-exclude-label': 'Exclude patterns',
  'action.create-worktree-bootstrap-setup-label': 'Setup command',
  'action.create-worktree-bootstrap-remember': 'Trust and run this goblin.toml config for this repository',
  'action.create-worktree-bootstrap-skip': 'Skip and create',
  'action.create-worktree-bootstrap-run': 'Run bootstrap',
  'action.menu': 'Actions',
  'action.refresh': 'Sync',
  ...
  'error.worktree-bootstrap-not-confirmed': 'Worktree bootstrap was not confirmed.',
