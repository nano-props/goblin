...
export const HOST_OPEN_SETTINGS_WINDOW_CHANNEL = 'goblin:shell-open-settings-window'
export const HOST_OPEN_EXTERNAL_URL_CHANNEL = 'goblin:shell-open-external-url'
export const HOST_OPEN_DIRECTORY_DIALOG_CHANNEL = 'goblin:shell-open-directory-dialog'
export const HOST_CONSUME_EXTERNAL_OPEN_PATHS_CHANNEL = 'goblin:shell-consume-external-open-paths'
