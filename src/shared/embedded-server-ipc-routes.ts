export const EMBEDDED_SERVER_IPC_ROUTES = {
  ...
  'workspace.directoryOverview': { route: '/api/workspace/directory-overview', method: 'POST' },
  'workspace.tree': { route: '/api/workspace/tree', method: 'POST' },
  'workspace.trashFile': { route: '/api/workspace/trash-file', method: 'POST' },
  'workspace.fileViewer': { route: '/api/workspace/file-viewer', method: 'POST' },
  'workspace.openTerminal': { route: '/api/workspace/open-terminal', method: 'POST' },
