 ...
 * on — the renderer's settings page needs them to render
 * platform-aware UI (default clone parent dir, terminal backend
 * list), and the embedded renderer's home-dir display reads the
 ...
 * is intentionally unauthenticated so the renderer can fetch it
 ...
 * host info into the renderer's bootstrap script before loadURL.
 */
