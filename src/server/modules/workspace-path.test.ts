...
describe('workspace native execution paths', () => {
  test('decodes a canonical local workspace only at the execution boundary', async () => {
  ...
  test('does not turn remote, malformed, or non-workspace targets into local paths', async () => {
  ...
  test('decodes an SSH workspace at its remote execution boundary', async () => {
