...
describe('parseGitRemoteUrl', () => {
  test('parses https, ssh, and scp-like remote URLs', async () => {
  ...
  test('normalizes browser URLs from supported remote URL forms', async () => {
  ...
  test('rejects malformed and local remotes', async () => {
...
describe('remote host providers', () => {
  test('detects GitHub and GitHub Enterprise hosts', async () => {
  ...
  test('detects GitLab and self-hosted GitLab hosts', async () => {
