 ...
 *
 * @param patternList one or more glob patterns to match
 * @param text the text to match
 */
export default function glob(patternList: string | string[], text: string): boolean {
...
function escapeChars(text: string, chars: string): string {
