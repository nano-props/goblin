...
export const zh: Record<DictKey, string> = {
  ...
  'terminal.bell-notification-title': '后台终端提醒',
  ...
  'settings.terminal-notifications-test-hint': '用当前通知链路触发一次测试通知。如果只看到 Dock 弹跳，请检查系统通知设置。',
  'settings.terminal-notifications-test-button': '显示测试通知',
  'settings.terminal-notifications-test-title': 'Goblin 测试通知',
  'settings.terminal-notifications-test-body': '如果你没有看到右上角通知，请检查 macOS 通知设置。',
  'settings.terminal-notifications-test-sent': '测试通知已发送',
  'settings.terminal-notifications-test-sent-hint':
    '如果只看到 Dock 弹跳、没有看到右上角通知，请检查 macOS 的 Goblin 通知设置。',
  'settings.terminal-notifications-test-failed': '无法显示测试通知',
  'settings.terminal-notifications-test-failed-hint': '当前通知调用没有成功返回。请稍后重试。',
