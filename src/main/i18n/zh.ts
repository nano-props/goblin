...
export const zh: Record<DictKey, string> = {
  ...
  'repo-tabs.open-remote-description': 'Connect to a Git repository on a remote server via SSH.',
  ...
  'repo-tabs.open-remote-path-placeholder': '/home/user/repo',
  ...
  'repo-tabs.open-remote-path-absolute': 'Path must be absolute',
