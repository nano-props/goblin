...
function resolveProjection(overrides: Partial<Parameters<typeof resolveWorkspacePaneCommandTargetProjection>[0]> = {}) {
  return resolveWorkspacePaneCommandTargetProjection({
