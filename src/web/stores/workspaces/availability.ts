...
type RepoAvailabilityTarget = Pick<WorkspaceState, 'availability' | 'remote'>
 ...
 * lifecycle signal.
 */
export function markRemoteLifecycleConnecting(repo: Pick<WorkspaceState, 'remote' | 'availability'>): void {
...
export function markRemoteLifecycleReady(
  repo: Pick<WorkspaceState, 'remote' | 'availability'>,
