...
export async function runRemoteWorkspaceConnection(
  ...
  const workspaceRuntimeId = options.workspaceRuntimeId ?? get().workspaces[repoRoot]?.workspaceRuntimeId
  ...
  if (result.kind === 'settled') {
    ...
    if (!runtime || get().workspaces[repoRoot]?.workspaceRuntimeId !== workspaceRuntimeId) {
