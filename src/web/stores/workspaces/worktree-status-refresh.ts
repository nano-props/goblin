import { refreshRepoWorktreeStatusReadModel } from '#/web/repos/query-runtime.ts'
...
function statusRefreshable(
  ...
  return !!repo && repo.workspaceRuntimeId === workspaceRuntimeId && gitWorkspaceCanExecute(repo)
}
