...
import { branchWorkspacePaneViewsRecordWith } from '#/web/stores/repos/branch-workspace-pane-views.ts'
...
function createRepo(
  ...
  repo.ui.openBranchWorkspacePaneViewsByBranch = branchWorkspacePaneViewsRecordWith(repo.ui, 'main', ['status'])
