...
import { restoreRestorableWorkspaceStateFromClientWorkspace } from '#/web/workspaces/persistence/restorable-state.ts'
...
import { readClientWorkspaceState } from '#/web/workspaces/persistence/client-state.ts'
