...
} from '#/web/terminal/components/terminal-geometry.ts'
import {
  observeTerminalTheme,
  terminalSearchDecorationsForCurrentDocument,
  terminalThemeForCurrentDocument,
} from '#/web/terminal/components/terminal-theme.ts'
import {
...
import type { TerminalFocusRequest, TerminalVirtualKey } from '#/web/terminal/components/types.ts'
import { installTerminalTouchScroll } from '#/web/terminal/components/terminal-touch-scroll.ts'
import {
  installTerminalViewportReveal,
  terminalInputRevealRow,
} from '#/web/terminal/components/terminal-viewport-reveal.ts'
import { terminalViewportText } from '#/web/terminal/components/terminal-viewport-text.ts'
