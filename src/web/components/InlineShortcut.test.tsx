...
describe('InlineShortcut', () => {
  test('renders the shortcut text', async () => {
  ...
  test('applies hover-only classes when showOnHover is true', async () => {
  ...
  test('does not apply hover-only classes by default', async () => {
    const { container } = renderInJsdom(<InlineShortcut shortcut="⌘N" />)
    const span = container.querySelector('span')
