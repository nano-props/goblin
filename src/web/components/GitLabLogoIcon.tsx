...
export const GitLabLogoIcon: FunctionalComponent<SVGAttributes> = ({ class: classValue, ...props }) => {
  return (
    <svg viewBox="90 90 200 200" aria-hidden="true" class={classValue} fill="none" {...props}>
      <path
        stroke="currentColor"
        stroke-width="12"
...
GitLabLogoIcon.inheritAttrs = false
