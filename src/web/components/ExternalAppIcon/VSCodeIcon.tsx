...
export const VSCodeIcon: FunctionalComponent<SVGAttributes> = ({ class: classValue, ...props }) => {
  return (
    <svg viewBox="0 0 96 96" aria-hidden="true" class={svgClass(classValue)} {...props}>
      <path
