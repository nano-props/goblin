...
export const GhosttyIcon: FunctionalComponent<SVGAttributes> = ({ class: classValue, ...props }) => {
  return (
    <svg viewBox="0 0 27 32" aria-hidden="true" class={svgClass(classValue)} {...props}>
      <path
...
GhosttyIcon.inheritAttrs = false
