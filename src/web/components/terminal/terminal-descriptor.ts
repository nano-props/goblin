...
import { terminalSlotKey, worktreeTerminalKey } from '#/web/components/terminal/terminal-workspace-slot-keys.ts'
...
export function terminalDescriptor(base: TerminalSessionBase, slotId: string, index: number): TerminalDescriptor {
  ...
  return {
    ...
    slotId,
    index,
    key: terminalSlotKey(base.repoRoot, base.worktreePath, slotId),
  }
}
