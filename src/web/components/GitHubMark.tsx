...
export const GitHubMark: FunctionalComponent<SVGAttributes> = ({ class: classValue, ...props }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" class={classValue} fill="currentColor" {...props}>
