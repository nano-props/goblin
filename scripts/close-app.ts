#!/usr/bin/env bun
// Close a running Goblin app before the install replaces it. macOS uses
// AppleScript + pgrep; Windows uses tasklist + taskkill. On other
// platforms this is a no-op, since the install flow only runs on macOS
// or Windows.
import { $ } from 'bun'
